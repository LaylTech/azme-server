...
opportunitiesGetBP = flask.Blueprint("opportunitiesGet", __name__)

from main import opportunitiesCol


@opportunitiesGetBP.route("/api/v1/opportunities/get", methods=["GET"])
async def opportunitiesGetFunction():
